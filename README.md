...
```
 ...
 - Age is used to determine if an ZOI should be deleted by the algorithm *(only for calculation of ZOI)*

```java
public double age;
```

 - Represents the number of visits influencing in the ZOI  *(only for calculation of ZOI)*
...
```
 ...
 To see a map the representation of a polygon, you can use this tool [https://arthur-e.github.io/Wicket/sandbox-gmaps3.html](https://arthur-e.github.io/Wicket/sandbox-gmaps3.html) which allows you to draw the ZOI polygon in WKT format.
