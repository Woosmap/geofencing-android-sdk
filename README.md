...
* [Notification APIs request](https://github.com/woosmap/woosmap-geofencing-android-sdk/blob/master/doc/APIsRequestInNotification.md): in use of a notification, Location of the mobile is one thing but knowing from what the mobile is close to is another thing. Find out here how to use Woosmap Search API to “geo contextualize” the location of your users.
...
* [Create and monitor geofences](https://github.com/woosmap/woosmap-geofencing-android-sdk/blob/master/doc/GeofencingRegions.md): Use region monitoring to determine when the user enters or leaves a geographic region.
...
* [Salesforce MarketingCloud Integration](https://github.com/woosmap/woosmap-geofencing-android-sdk/blob/master/doc/MarketingCloudConnector.md): Track location data and generate contextual events using custom event types and push it to SFMC.
